...
class Menu extends Component {
  render() {
    return (
      <nav id="menu">
        <a onClick={() => this.props.scroll({ ref: this.props.refs.clients, x: 0, y: 0 })}>
          <img src="images/heart.png" className="icon heart" alt="clients" />
          clients
        </a>
        <a onClick={() => this.props.scroll({ ref: this.props.refs.apps, x: 0, y: 0 })}>
          <img src="images/tool.png" className="icon rocket" alt="apps" />
          { this.props.windowWidth < 475 ? "apps" : "applications" }
        </a>
        <a onClick={() => this.props.scroll({ ref: this.props.refs.contact, x: 0, y: 0 })}>
